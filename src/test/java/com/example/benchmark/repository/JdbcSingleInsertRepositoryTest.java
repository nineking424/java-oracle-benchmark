...
/**
 * JdbcSingleInsertRepository 테스트.
 *
...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("JdbcSingleInsertRepository 테스트")
class JdbcSingleInsertRepositoryTest {

    @Autowired
    private JdbcSingleInsertRepository repository;
    ...
    class GetTypeNameTest {
        ...
        void shouldReturnTypeName() {
            assertThat(repository.getTypeName()).isEqualTo("JDBC-Single");
        }
    }
}
